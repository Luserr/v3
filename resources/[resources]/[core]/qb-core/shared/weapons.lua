...
QBShared.Weapons = {
	...
	--- SMGs
	[`weapon_microsmg2`]  			 				= {['name'] = 'weapon_microsmg2', 		 	  	['label'] = 'Uzi', 			['weapontype'] = 'Submachine Gun', 				 					['ammotype'] = 'AMMO_SMG',	                       ['damagereason'] = 'Died'},
	[`weapon_microsmg3`]  			 				= {['name'] = 'weapon_microsmg3', 		 	  	['label'] = 'Mac-10', 			['weapontype'] = 'Submachine Gun' ,				 				['ammotype'] = 'AMMO_SMG',	                       ['damagereason'] = 'Died'},	
	[`weapon_nailgun`] 			 	 				= {['name'] = 'weapon_nailgun', 		 	  	['label'] = 'Nail Gun', 			['weapontype'] = 'Submachine Gun' ,				 			['ammotype'] = 'AMMO_NAIL',                       ['damagereason'] = 'Died to a fkn nailgun'},		
	[`weapon_minismg2`] 				 			= {['name'] = 'weapon_minismg2', 				['label'] = 'Skorpion', 			['weapontype'] = 'Submachine Gun',							['ammotype'] = 'AMMO_SMG',							['damagereason'] = 'Submachine Gunned'},

--- SHOTGUNS
	[`weapon_ltl`] 			 			 			= {['name'] = 'weapon_ltl', 	 	  			['label'] = 'LTL Shotgun', 				 		['ammotype'] = 'AMMO_SHOTGUN',		                       ['damagereason'] = 'Died'},	

--- SNIPER RIFLES / DMR RIFLES
	[`weapon_dragunov`] 							= {['name'] = 'weapon_dragunov', 	 	  				['label'] = 'Dragunov DMR', 			 	['ammotype'] = 'AMMO_SNIPER',	                       ['damagereason'] = 'Died'},
...
-- NEWEST NP ADDS
	...
	[`weapon_g22`] 		     	 					= {['name'] = 'weapon_g22', 		 	  		['label'] = 'AWM', 			 	['ammotype'] = 'AMMO_UNKNOWN',                       ['damagereason'] = 'Died'},
-- NEWEST NP ADDS
...
--- THROWABLES
    [`weapon_shoe`] 		     					= {['name'] = 'weapon_shoe', 		 	  	['label'] = 'Stolen Shoes', 	['weapontype'] = 'Throwable',									['ammotype'] = nil,                       ['damagereason'] = 'Died to smelly shoes'},					
	[`weapon_book`] 		 						= {['name'] = 'weapon_book', 	      		['label'] = 'Book', 			['weapontype'] = 'Throwable',		 								['ammotype'] = nil,					       ['damagereason'] = 'Death by book'},
	[`weapon_brick`] 		 						= {['name'] = 'weapon_brick', 	      		['label'] = 'Brick', 			['weapontype'] = 'Throwable',		 								['ammotype'] = nil,	                       ['damagereason'] = 'Death by brick'},				
	[`weapon_cash`] 		 						= {['name'] = 'weapon_cash', 	      		['label'] = 'Racks', 			['weapontype'] = 'Throwable',		 								['ammotype'] = nil,	                       ['damagereason'] = 'Too much money to handle'},
