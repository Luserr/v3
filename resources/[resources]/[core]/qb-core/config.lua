...
QBConfig.Money = {}
QBConfig.Money.MoneyTypes = { cash = 500, bank = 5000, crypto = 50 } -- type = startamount - Add or remove money types for your server (for ex. blackmoney = 0), remember once added it will not be removed from the database!
...
QBConfig.Server.Permissions = {'god', 'admin', 'mod', 'reloadedcapitalist', 'reloadedgold', 'reloadedsilver', 'reloadedvip','reloadedsupporter'} -- permission list
