...
RegisterNetEvent("nc-dices:ToggleDisplay")
AddEventHandler("nc-dices:ToggleDisplay", function(playerId, number, typ)
	diceDisplaying[tonumber(playerId)] = {num = number, time = GetGameTimer() + displayTime, type = typ}
end)

RegisterNetEvent("nc-dices:ToggleDiceAnim")
AddEventHandler("nc-dices:ToggleDiceAnim", function()
