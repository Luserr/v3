...
exports["qb-target"]:AddBoxZone("gabzpdmprinter", vector3(-37.49613, -1086.832, 27.274368), 1.3, 1.5, {
    name="gabzpdmprinter",
    heading=340,
    --debugPoly=true,
    minZ=26.27,
...
exports["qb-target"]:AddBoxZone("gabzmrpdpdprinter", vector3(476.71887, -1001.881, 27.515474), 0.5, 0.5, {
...
exports["qb-target"]:AddBoxZone("gabzmrpdpdprinter2", vector3(465.16122, -983.8348, 31.431491), 0.5, 0.5, {
...
exports["qb-target"]:AddBoxZone("hayesprinter", vector3(-1429.532, -455.3938, 35.909664), 1.3, 1.3, {
    name="hayesprinter",
    heading=0,
    --debugPoly=true,
    minZ=34.55,
