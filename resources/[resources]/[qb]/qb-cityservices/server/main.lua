...
local function AddSocietyMoney(amount)
    if UseBossMenu then
        ...
        exports['Renewed-Banking']:addAccountMoney(Config.SocietyAccount, amount, "City Service")
    end
end

local function RemoveSocietyMoney(amount)
    if UseBossMenu then
        TriggerEvent('qb-bossmenu:server:removeAccountMoney', Config.SocietyAccount, amount)
    else
        exports['Renewed-Banking']:removeAccountMoney(Config.SocietyAccount, amount, "City Service")
    end
end
...
RegisterNetEvent('sd-cityservices:server:GetLicense', function(type)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('sd-cityservices:server:ApplyJob', function(data)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    ...
    if IsAvailable then
        ...
        exports['qb-phone']:hireUser(data.job, Player.PlayerData.citizenid, 0)
...
RegisterNetEvent('sd-cityservices:server:RegisterCompany', function(name, type)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local cash = Player.PlayerData.money['cash']
    local bank = Player.PlayerData.money['bank']
...
RegisterNetEvent('sd-cityservices:server:PurchaseCompany', function(data)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local cash = Player.PlayerData.money['cash']
    local bank = Player.PlayerData.money['bank']
...
RegisterNetEvent('sd-cityservices:server:SellCompany', function(data)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local company = Config.Companies[data.id]
    if company then
...
RegisterNetEvent('sd-cityservices:server:DissolveCompany', function(data)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('sd-cityservices:server:ChangeCompanyName', function(data)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local cash = Player.PlayerData.money['cash']
    local bank = Player.PlayerData.money['bank']
...
RegisterNetEvent('sd-cityservices:server:ChangeCompanyType', function(data)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local cash = Player.PlayerData.money['cash']
    local bank = Player.PlayerData.money['bank']
...
RegisterNetEvent('sd-cityservices:server:InvestCompany', function(data)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local cash = Player.PlayerData.money['cash']
    local bank = Player.PlayerData.money['bank']
...
-- Callbacks
QBCore.Functions.CreateCallback("sd-cityservices:server:GetRegisteredCompany", function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    cb(GetRegisteredCompany(Player.PlayerData.citizenid))
end)

QBCore.Functions.CreateCallback("sd-cityservices:server:GetOwnedCompanies", function(source, cb)
...
QBCore.Functions.CreateCallback("sd-cityservices:server:GetPlayerOwnedCompanies", function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    cb(GetOwnedCompaniesByPlayer(Player.PlayerData.citizenid))
end)

QBCore.Functions.CreateCallback("sd-cityservices:server:HasBusinessLicense", function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
