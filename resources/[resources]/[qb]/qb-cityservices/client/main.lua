...
local function GetPlayerOwnedCompanies()
    local p = promise.new()
    QBCore.Functions.TriggerCallback('sd-cityservices:server:GetPlayerOwnedCompanies', function(result)
        p:resolve(result)
    end)
...
local function CheckPlayerHasBusinessLicense()
    local p = promise.new()
    QBCore.Functions.TriggerCallback('sd-cityservices:server:HasBusinessLicense', function(result)
        p:resolve(result)
    end)
    return Citizen.Await(p)
end
...
CreateThread(function()
    ...
    for k, v in pairs(Config.Licenses) do
        cityservices[#cityservices+1] = {
            action = function(entity)
                TriggerServerEvent('sd-cityservices:server:GetLicense', v.type)
            end,
            icon = v.icon,
            label = v.label,
        }
    ...
    cityservices[#cityservices+1] = {
        type = 'client',
        event = 'sd-cityservices:client:Jobs',
    ...
    -- Citizen Target
    if Config.UseShmannWorks then
        exports['qb-target']:AddBoxZone('cityservices_citizen', vector3(-554.08, -185.25, 38.22), 1, 1, {
        ...
        exports['qb-target']:AddBoxZone('cityservices_counter', vector3(-555.3, -186.25, 38.22), 1, 1, {
            ...
            maxZ = 39.0,
                ...
                options = {
                    {
                        type = 'client',
                        event = 'sd-cityservices:client:Counter',
        ...
        exports['qb-target']:AddBoxZone('cityservices_citizen', cityservices_citizen.coords, cityservices_citizen.length, cityservices_citizen.width, {
            name = 'cityservices_citizen',
        ...
        exports['qb-target']:AddBoxZone('cityservices_counter', cityservices_counter.coords, cityservices_counter.length, cityservices_counter.width, {
            name = 'cityservices_counter',
    ...
    if Config.RegisterCompanyEnabled then
        companies[#companies+1] = {
            type = 'client',
            event = 'sd-cityservices:client:RegisteredCompany',
    ...
    if Config.CompanyEnabled then
        companies[#companies+1] = {
            type = 'client',
            event = 'sd-cityservices:client:OwnedCompanies',
    ...
    -- Company Target
    if Config.UseShmannWorks then
        exports['qb-target']:AddBoxZone('cityservices_company', vector3(-557.11, -186.97, 38.22), 1, 1, {
        ...
        exports['qb-target']:AddBoxZone('cityservices_company', cityservices_company.coords, cityservices_company.length, cityservices_company.width, {
            name = 'cityservices_company',
...
RegisterNetEvent('sd-cityservices:client:Jobs',function()
    QBCore.Functions.TriggerCallback('sd-cityservices:server:GetOwnedCompanies', function(companies)
        local jobsMenu = {
            {
        ...
        for k, v in pairs(Config.Jobs) do
            if not OwnedCompanies[v.name] then
                jobsMenu[#jobsMenu+1] = {
                    ...
                    icon = v.icon,
                    params = {
                        event = 'sd-cityservices:client:ViewJob',
                        args = {
                            job = v
                        }
                    }
        ...
        exports['qb-menu']:openMenu(jobsMenu)
    end)
end)

RegisterNetEvent('sd-cityservices:client:ViewJob',function(data)
    local jobMenu = {}
    if data.job.image ~= nil then
        jobMenu[#jobMenu+1] = {
            isMenuHeader = true,
            header = '<img src=nui://sd-cityservices/images/'..data.job.image..' width=100% onerror="this.onerror=null; this.remove();"> <img src='..data.job.image..' onerror="this.onerror=null; this.remove();" width=100%>',
        }
    else
        jobMenu[#jobMenu+1] = {
            isMenuHeader = true,
    ...
    jobMenu[#jobMenu+1] = {
        ...
        params = {
            event = 'sd-cityservices:client:ApplyJob',
            args = {
                job = data.job.name
            }
        }
...
RegisterNetEvent('sd-cityservices:client:ApplyJob',function(data)
    exports['qb-menu']:openMenu({
        ...
        },
        {
            ...
            params = {
                isServer = true,
                event = 'sd-cityservices:server:ApplyJob',
                args = {
                    job = data.job
                }
            }
...
RegisterNetEvent('sd-cityservices:client:Counter',function()
...
RegisterNetEvent('sd-cityservices:client:RegisteredCompany',function()
    local registeredCompanyMenu = {}
    QBCore.Functions.TriggerCallback('sd-cityservices:server:GetRegisteredCompany', function(company)
        if company then
            ...
            registeredCompanyMenu[#registeredCompanyMenu+1] = {
                ...
                params = {
                    event = 'sd-cityservices:client:InvestCompany',
                    args = {
                        company = company
                    }
                }
            ...
            registeredCompanyMenu[#registeredCompanyMenu+1] = {
                ...
                params = {
                    event = 'sd-cityservices:client:EditCompany',
                    args = {
                        company = company
                    }
                }
            ...
            registeredCompanyMenu[#registeredCompanyMenu+1] = {
                ...
                params = {
                    event = 'sd-cityservices:client:DissolveCompany',
                    args = {
                        company = company
                    }
                }
            ...
            registeredCompanyMenu[#registeredCompanyMenu+1] = {
                ...
                params = {
                    event = 'sd-cityservices:client:RegisterCompany'
                }
            }
        end
        registeredCompanyMenu[#registeredCompanyMenu+1] = {
        ...
        exports['qb-menu']:openMenu(registeredCompanyMenu)
    end)
end)

RegisterNetEvent('sd-cityservices:client:InvestCompany',function(data)
    exports['qb-menu']:openMenu({
        {
            isMenuHeader = true,
        ...
        },
        {
            ...
            params = {
                event = 'sd-cityservices:client:InvestAmountCompany',
                args = {
...
RegisterNetEvent('sd-cityservices:client:InvestAmountCompany',function(data)
    local companyAmountInput = exports['qb-input']:ShowInput({
    ...
    if companyAmountInput then
        ...
        if companyAmountInput.amount ~= nil and tonumber(companyAmountInput.amount) > 0 then
            TriggerEvent('sd-cityservices:client:Confirm', { 
                ...
                event = {
                    confirm = 'sd-cityservices:server:InvestCompany',
                    back = 'sd-cityservices:client:RegisteredCompany',
                },
                args = {
...
RegisterNetEvent('sd-cityservices:client:DissolveCompany',function(data)
    TriggerEvent('sd-cityservices:client:Confirm', { 
        ...
        event = {
            confirm = 'sd-cityservices:server:DissolveCompany',
            back = 'sd-cityservices:client:RegisteredCompany',
        },
        args = {
...
RegisterNetEvent('sd-cityservices:client:EditCompany',function(data)
    exports['qb-menu']:openMenu({
        {
            isMenuHeader = true,
        ...
        },
        {
            ...
            params = {
                event = 'sd-cityservices:client:EditCompanyName',
                args = {
                    company = data.company
                }
            }
        },
        {
            ...
            icon = 'fa-solid fa-briefcase',
            params = {
                event = 'sd-cityservices:client:EditCompanyType',
                args = {
                    company = data.company
                }
            }
...
RegisterNetEvent('sd-cityservices:client:EditCompanyName',function(data)
    local companyNameInput = exports['qb-input']:ShowInput({
        header = Lang:t('menu.register_company_edit_name'),
    ...
    if companyNameInput then
        if not companyNameInput.name then
            TriggerEvent('sd-cityservices:client:RegisteredCompany')
        ...
        if #companyNameInput.name < Config.RegisterCompanyNameMin or #companyNameInput.name > Config.RegisterCompanyNameMax then
            ...
            TriggerEvent('sd-cityservices:client:Confirm', { 
                ...
                button = Lang:t('menu.confirm'),
                event = {
                    confirm = 'sd-cityservices:server:ChangeCompanyName',
                    back = 'sd-cityservices:client:RegisteredCompany',
                },
                args = {
...
RegisterNetEvent('sd-cityservices:client:EditCompanyType',function(data)
    local companyTypeInput = exports['qb-input']:ShowInput({
    ...
    if companyTypeInput then
        ...
        TriggerEvent('sd-cityservices:client:Confirm', { 
            ...
            button = Lang:t('menu.confirm'),
            event = {
                confirm = 'sd-cityservices:server:ChangeCompanyType',
                back = 'sd-cityservices:client:RegisteredCompany',
            },
            args = {
...
RegisterNetEvent('sd-cityservices:client:RegisterCompany',function()
    local companyNameInput = exports['qb-input']:ShowInput({
    ...
    if companyNameInput then
        if not companyNameInput.name then
            TriggerEvent('sd-cityservices:client:RegisterCompany')
            QBCore.Functions.Notify(Lang:t('error.name_length', { min = Config.RegisterCompanyNameMin, max = Config.RegisterCompanyNameMax }), 'error')
            return
        end
        ...
        if #companyNameInput.name < Config.RegisterCompanyNameMin or #companyNameInput.name > Config.RegisterCompanyNameMax then
            ...
            TriggerServerEvent('sd-cityservices:server:RegisterCompany', companyNameInput.name, companyNameInput.type) 
        end
    end
end)

RegisterNetEvent('sd-cityservices:client:OwnedCompanies',function()
    ...
    QBCore.Functions.TriggerCallback('sd-cityservices:server:GetOwnedCompanies', function(companies)
        for k, v in pairs(Config.Companies) do
            ...
            if company ~= nil then
                ownedCompanyMenu[#ownedCompanyMenu+1] = {
                    ...
                    params = {
                        event = 'sd-cityservices:client:ViewOwnedCompany',
                        args = {
                            id = k,
                            company = company
                        }
                ...
                ownedCompanyMenu[#ownedCompanyMenu+1] = {
                    header = v.name,
                    params = {
                        event = 'sd-cityservices:client:ViewPurchaseCompany',
                        args = {
                            id = k
                        }
                    }  
        ...
        exports['qb-menu']:openMenu(ownedCompanyMenu)
    end)
end)

RegisterNetEvent('sd-cityservices:client:ViewOwnedCompany',function(data)
    local companyMenu = {}
    local company = Config.Companies[data.id]
    if company.image ~= nil then
        companyMenu[#companyMenu+1] = {
            isMenuHeader = true,
            header = '<img src=nui://sd-cityservices/images/'..company.image..' width=100% onerror="this.onerror=null; this.remove();"> <img src='..company.image..' onerror="this.onerror=null; this.remove();" width=100%>',
        }
    else
        companyMenu[#companyMenu+1] = {
            isMenuHeader = true,
    ...
    if data.company.citizenid == PlayerData.citizenid then
        companyMenu[#companyMenu+1] = {
            ...
            icon = 'fa-solid fa-dollar-sign',
            params = {
                event = 'sd-cityservices:client:SellCompany',
                args = {
                    id = data.id
                }
            }
    ...
    exports['qb-menu']:openMenu(companyMenu)
end)

RegisterNetEvent('sd-cityservices:client:ViewPurchaseCompany',function(data)
    local companyMenu = {}
    local company = Config.Companies[data.id]
    if company.image ~= nil then
        companyMenu[#companyMenu+1] = {
    ...
    companyMenu[#companyMenu+1] = {
        ...
        icon = 'fa-solid fa-dollar-sign',
        params = {
            event = 'sd-cityservices:client:PurchaseCompany',
            args = {
                id = data.id
            }
        }
...
RegisterNetEvent('sd-cityservices:client:PurchaseCompany',function(data)
    local company = Config.Companies[data.id]
    ...
    if Config.CompanyLimited and #companyAmount > 0 then
        ...
        TriggerEvent('sd-cityservices:client:OwnedCompanies')
        return
    end
    ...
    exports['qb-menu']:openMenu({
        ...
        },
        {
            ...
            params = {
                isServer = true,
                event = 'sd-cityservices:server:PurchaseCompany',
                args = {
                    id = data.id
                }
            }
...
RegisterNetEvent('sd-cityservices:client:SellCompany',function(data)
    local company = Config.Companies[data.id]
    exports['qb-menu']:openMenu({
        {
            isMenuHeader = true,
        ...
        },
        {
            ...
            params = {
                isServer = true,
                event = 'sd-cityservices:server:SellCompany',
                args = {
                    id = data.id
                }
            }
...
RegisterNetEvent('sd-cityservices:client:Confirm',function(data)
    exports['qb-menu']:openMenu({
        {
            isMenuHeader = true,
            header = data.header,
