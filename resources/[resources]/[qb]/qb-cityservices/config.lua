...
-- stashitems   =   qb-inventory / lj-inventory / aj-inventory
...
Config.Locations = {
    ['blip'] = {
        ...
        scale = 0.8,
        colour = 0,
        coords = vector3(-552.26, -192.3, 38.47)
    },
    ['citizens'] = {
        length = 0.5,
        width = 1,
        ...
        minZ = 38.13,
        maxZ = 39.23,
        coords = vector3(-543.58, -198.14, 38.23) 
    },
    ['counter'] = {
        length = 1,
        width = 0.5,
        ...
        minZ = 38.13,
        maxZ = 39.23,
        coords = vector3(-543.42, -197.06, 38.23)
    },
    ['companies'] = {
        length = 0.5,
        width = 1.0,
        ...
        minZ = 38.13,
        maxZ = 39.23,
        coords = vector3(-551.02, -202.52, 38.23)
    }
}
...
Config.Licenses = {
    { label = "Request ID", icon = "fas fa-id-card", item = "id_card", price = 50, type = "id", verify = false, limited = true },
    { label = "Request Driver's License", icon = "fas fa-car", item = "driver_license", price = 50, type = "driver", verify = false, limited = true },
    { label = "Request Lawyer License", icon = "fas fa-balance-scale", item = "lawyerpass", price = 50, type = "lawyer", verify = true, limited = true },
    { label = "Request Hunting License", icon = "fas fa-balance-scale", item = "huntinglicense", price = 50, type = "hunting", verify = true, limited = true },
    { label = "Request Weapon License", icon = "fas fa-shield-alt", item = "weaponlicense", price = 50, type = "weapon", verify = true, limited = true },
    { label = "Request Fishing License", icon = "fas fa-shield-alt", item = "fishing_license", price = 50, type = "fishing", verify = true, limited = true },
}
...
Config.LicenseTemplates = function(license, player)
    ...
    elseif license.type == "lawyer" then
        info.id = '#' .. tostring(QBCore.Shared.RandomInt(2) .. QBCore.Shared.RandomInt(3) .. QBCore.Shared.RandomInt(1))
        info.firstname = player.charinfo.firstname
        info.lastname = player.charinfo.lastname
        info.citizenid = player.citizenid
