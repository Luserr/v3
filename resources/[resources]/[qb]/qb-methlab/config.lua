...
-- Meth runs.
Config.StartMethPayment = 1500 -- How much you pay at the start to start the run

Config.RunAmount = math.random(6,9) -- How many drop offs the player does before it automatixally stops.
...
Config.BigRewarditemChance = 10 -- Percentage of getting rare item on Meth run. Multiplied by 100. 0.1% = 1, 1% = 10, 20% = 200, 50% = 500, etc. Default 0.1%.
