...
Drones.Disconnect = function(drone,destroy)
  ...
  if not destroy and Vdist(drone_pos,ply_pos) <= 10.0 then
    ...
    TriggerServerEvent("nc_drones:server:DroneReturned", Player.source)
...
RegisterNetEvent("nc_drones:client:UseDrone")
AddEventHandler("nc_drones:client:UseDrone", function() 
