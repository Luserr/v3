...
Shared.BoostInterval = 25 -- How many minutes between new boost contracts
...
Shared.MoneyType = 'gne' -- The money used to start a contract, make sure to edit the UI too in he app.js to fit your moneytype.
...
Shared.MinCops = 2 -- Minimum cops required for the server to send contracts if option enabled
...
Shared.Contracts = {
    ['D'] = {
        vehicles = {'washington', 'tornado', 'dilettante', 'bison', 'bison', 'futo', 'minivan', 'issi2'}, -- You can always add more vehicles here
    ...
    ['C'] = {
        vehicles = {'sultan', 'panto', 'ap4','civic','honody', 'ram2500'},
        locations = {
            [1] = {
    ...
    ['B'] = {
        vehicles = {'rr68demoncharger', 'f150', 'm3e46', 'cliors', 'bgnx', 'rr14' },
        locations = {
            [1] = {
    ...
    ['A'] = {
        vehicles = {'exor', 's15rb', 'bmwm2h', 'subwrx', 'veln', '300chellcat'},
        locations = {
            [1] = {
    ...
    ['S'] = {
        vehicles = {'filthynsx', '488gtb', 'r8v10', 'r32', 'c7', 'lc500', 'gtr'},
        locations = {
            [1] = {
        ...
        minRep = 801,
        maxRep = 1500,
        price = {min = 85,  max = 105},
        reward = {min = 125, max = 155},
        exp = {buyin = 34, payout = 51},
        hacks = 15,
        dropCops = 0,
        vinCops = 0,
    ...
    ['S+'] = {
        vehicles = {'victor', 'zupra2', 'r8h', 'valkyrietp', 'KoenigseggAgeraR', 'tempesta2'},
        locations = {
            [1] = {
