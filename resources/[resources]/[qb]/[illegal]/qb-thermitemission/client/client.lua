...
Citizen.CreateThread(function()
    exports['qb-target']:AddTargetModel(Config.ModelPed, {
        options = {
            {
            event = "venture:client:StartThermiteMission",
            type = 'client',
            icon = 'fas fa-laptop',
            label = 'Thermite Mission',
            },
        },
        distance = 2.0
    })
...
RegisterNetEvent('venture:client:StartThermiteMission')
AddEventHandler('venture:client:StartThermiteMission', function()
    ...
    Citizen.CreateThread(function()
        while true do
            ...
            if Distance < 5.0 then
                ...
                DeleteEntity(car)
                Citizen.Wait(20000)
                TriggerServerEvent("CL-ThermiteMission:server:AddItem", Config.ThermiteItem, math.random(Config.MinEarn,Config.MaxEarn))
...
function SpawnGuards()
    ...
    for k, v in pairs(Config.Guards) do
        ...
        exports['qb-dispatch']:ThermiteRobbery()
    end
