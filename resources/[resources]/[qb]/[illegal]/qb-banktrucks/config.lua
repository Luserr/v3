...
Config.RareItem = "security_card_02" -- Change to whatever item you want the rare item to get is
Config.RareItemAmt = "2" -- Amount of the rare item you want to be given
