...
RegisterNetEvent('Kibra:Motels:Server:AddBilling', function()
	...
	for k,v in pairs(Config.Motels) do
		if #PlayerMotels > 0 then
			if v.Payment then
				exports['Renewed-Banking']:addAccountMoney("voncrastenburg", v.InvoiceAmount, "Motels")
		...
		for k,v in pairs(MotelData) do
			...
			if BillPlayer then
				...
				if PlyMoney >= Config.Motels[Motel].InvoiceAmount then
					...
					exports['Renewed-Banking']:addAccountMoney("voncrastenburg", Config.Motels[Motel].InvoiceAmount, "Motels")
