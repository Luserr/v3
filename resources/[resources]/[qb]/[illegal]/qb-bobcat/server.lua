...
RegisterNetEvent('gc-bobcatheist:server:LockerItem', function(type)
    ...
    player.Functions.AddItem('rifle_ammo', 15, false)
    TriggerClientEvent('inventory:client:ItemBox', src, QBCore.Shared.Items['weapon_grenade'], 'add')
    TriggerClientEvent('inventory:client:ItemBox', src, QBCore.Shared.Items['weapon_assaultrifle2'], "add")
end)
