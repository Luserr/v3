...
Config.Artgallery = false -- Set to true if using lh34-artgalleryheist
Config.Casinoheist = true -- Set to true if using lh34-casinoheist
Config.MinimumThermitePolice = 4 -- Required amount of cops to be able to hit the powerplant stations
