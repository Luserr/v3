...
RegisterServerEvent('qb-drugprocessing:pickedUpCannabis', function()
	local src = source
...
RegisterServerEvent('qb-drugprocessing:processCannabis', function()
	local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('qb-drugprocessing:rollJoint', function()
	local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
QBCore.Functions.CreateUseableItem("rolling_paper", function(source, item)
    ...
    TriggerClientEvent('qb-drugprocessing:client:rollJoint', source, 'marijuana', item)
end)