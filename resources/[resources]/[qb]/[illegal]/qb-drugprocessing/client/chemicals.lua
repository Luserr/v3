...
local function createChemicalMenu()
    local chemMenu = {
        ...
        },
        {
			...
			params = {
                event = "qb-drugprocessing:hydrochloric_acid",
            }
        },
        {
            ...
            txt = Lang:t("menu.chemicals"),
			params = {
                event = "qb-drugprocessing:sodium_hydroxide",
            }
        },
        {
            ...
            txt = Lang:t("menu.chemicals"),
			params = {
                event = "qb-drugprocessing:sulfuric_acid",
            }
        },
        {
...
RegisterNetEvent('qb-drugprocessing:chemicalmenu', createChemicalMenu)
...
local function process_hydrochloric_acid()
	...
	QBCore.Functions.Progressbar("search_register", Lang:t("progressbar.processing"), 15000, false, true, {
		...
		TriggerServerEvent('qb-drugprocessing:processHydrochloric_acid')
...
local function process_lsa()
	...
	QBCore.Functions.Progressbar("search_register", Lang:t("progressbar.processing"), 15000, false, true, {
		...
		TriggerServerEvent('qb-drugprocessing:process_lsa')
...
local function process_sulfuric_acid()
	...
	QBCore.Functions.Progressbar("search_register", Lang:t("progressbar.processing"), 15000, false, true, {
		...
		TriggerServerEvent('qb-drugprocessing:processprocess_sulfuric_acid')
...
local function process_sodium_hydroxide()
	...
	QBCore.Functions.Progressbar("search_register", Lang:t("progressbar.processing"), 15000, false, true, {
		...
		TriggerServerEvent('qb-drugprocessing:processsodium_hydroxide')
...
RegisterNetEvent("qb-drugprocessing:hydrochloric_acid", function()
...
RegisterNetEvent("qb-drugprocessing:lsa", function()
    QBCore.Functions.TriggerCallback('qb-drugprocessing:validate_items', function(result)
		if result then
			process_lsa()
		else
...
RegisterNetEvent("qb-drugprocessing:sulfuric_acid", function()
    QBCore.Functions.TriggerCallback('qb-drugprocessing:validate_items', function(result)
		if result then
...
RegisterNetEvent("qb-drugprocessing:sodium_hydroxide", function()
    QBCore.Functions.TriggerCallback('qb-drugprocessing:validate_items', function(result)
		if result then
...
RegisterNetEvent("qb-drugprocessing:pickChemicals", function()
	local playerPed = PlayerPedId()
	...
	if nearbyObject and IsPedOnFoot(playerPed) then
		...
		QBCore.Functions.Progressbar("search_register", Lang:t("progressbar.pickup_chemicals"), 10000, false, true, {
			...
			TriggerServerEvent('qb-drugprocessing:pickedUpChemicals')
			isPickingUp = false
