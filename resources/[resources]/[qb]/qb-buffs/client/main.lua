...
function AddBuff(buffName, time)
    local p = promise.new()
...
function StaminaBuffEffect(time, value)
...
function SwimmingBuffEffect(time, value)
...
function AddHealthBuff(time, value) 
...
function AddArmorBuff(time, value)
...
function AddStressBuff(time, value)
