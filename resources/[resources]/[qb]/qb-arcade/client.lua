...
function displayTime()
    exports['qb-casinoui']:DrawCasinoUi('show', "Arcade Card Time</br> "..minutes..":"..seconds)
end
...
CreateThread(function()
    ArcadeBlip = AddBlipForCoord(Config.Blip.coords)
    SetBlipSprite (ArcadeBlip, 673)
    SetBlipDisplay(ArcadeBlip, 4)
    SetBlipScale  (ArcadeBlip, 0.50)
    SetBlipAsShortRange(ArcadeBlip, true)
    SetBlipColour(ArcadeBlip, 47)
    BeginTextCommandSetBlipName("STRING")
    AddTextComponentSubstringPlayerName("Arcade")
...
--=================================== Peds
local arcade= {
  {-1292.76, -302.31, 36.05 - 1.0 ,"Arcade",295.514,0x72551375,"cs_lifeinvad_01"},
