...
RegisterNetEvent('qb-bahma:Client:signOn', function()
    if LocalPlayer.state['isLoggedIn'] and PlayerData.job.name == "bahma" then 
        TriggerServerEvent("QBCore:ToggleDuty")
    end
end)

RegisterNetEvent('qb-bahma:Client:stash', function()
    if onDuty and PlayerData.job.name == "bahma" then
...
RegisterNetEvent('qb-bahma:Client:accessBarMenu', function(data) -- Access bar menu, exploit checks
...
RegisterNetEvent('qb-bahma:Client:purchaseDrink', function(data) -- purchase drinks, exploit check
    name = data.type.name
    ...
    if name and price then 
        barConfirmation = {
            ...
            },
            {
                ...
                params = {
                    isServer = true,
                    event = "qb-bahma:Server:handleItem",
                    args = {
                        type = data.type.item,
...
RegisterNetEvent('qb-bahma:Client:barMenu', function() -- Open bar menu
    exports["qb-menu"]:openMenu(drinks)
end)

RegisterNetEvent('qb-bahma:Client:employeeManagement', function() -- Open boss menu
