       ...
       if (IsPedInAnyVehicle(PlayerPedId(), false)) then
            ...
            if ModdedVehicles[vehicleIdentifier] == nil and not IsThisModelABicycle(GetEntityModel(veh)) then
                ...
                if IsThisModelABike(GetEntityModel(vehicleIdentifier)) then
                    ...
                    --[[ print('Before',GetVehicleHandlingFloat(vehicleIdentifier, 'CHandlingData', 'fInitialDriveForce'))
                    SetVehicleHandlingFloat(vehicleIdentifier, 'CHandlingData', 'fInitialDriveForce', 5.5)
                    print('After',GetVehicleHandlingFloat(vehicleIdentifier, 'CHandlingData', 'fInitialDriveForce')) ]]
