...
--[[RegisterServerEvent('washer:server:compressor')
AddEventHandler('washer:server:compressor', function()
    TriggerClientEvent("washer:compressor:createobject", source, 'prop_compressor_02')
end)]]