...
RegisterNetEvent('hospital:client:UseIfaks', function()
    ...
    QBCore.Functions.Progressbar("use_bandage", Lang:t('progress.ifaks'), 15000, false, true, {
        ...
        TriggerServerEvent('qb-smallresources:server:RemoveItem', "ifaks", 1)
...
RegisterNetEvent('hospital:client:UseBandage', function()
    ...
    QBCore.Functions.Progressbar("use_bandage", Lang:t('progress.bandage'), 4000, false, true, {
        ...
        TriggerServerEvent('qb-smallresources:server:RemoveItem', "bandage", 1)
...
RegisterNetEvent('hospital:client:UsePainkillers', function()
    ...
    QBCore.Functions.Progressbar("use_bandage", Lang:t('progress.painkillers'), 3000, false, true, {
        ...
        TriggerServerEvent('qb-smallresources:server:RemoveItem', "painkillers", 1)
            ...
            if bleedTickTimer >= Config.BleedTickRate and not isInHospitalBed then
                if not isDead and not InLaststand then
                    if isBleeding > 0 then
                        ...
                        TriggerServerEvent("evidence:server:CreateBloodDrop", QBCore.Functions.GetPlayerData().citizenid, QBCore.Functions.GetPlayerData().metadata["bloodtype"], coords, QBCore.Functions.GetPlayerData().charinfo.bloodnumber)
