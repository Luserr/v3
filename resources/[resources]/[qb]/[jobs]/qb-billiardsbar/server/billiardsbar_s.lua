...
RegisterServerEvent('boii-billiardsbar:server:MicrowaveFood', function(args) 
    ...
    if args == 1 then 
        ...
        if food ~= nil then           
            ...
            --TriggerServerEvent("qb-smallresources:server:RemoveItem", 'cheesepie', 1)
            --QBCore.Functions.RemoveItem('cheesepie')
    ...
    elseif args == 2 then 
        ...
        if food ~= nil then           
            ...
            --TriggerServerEvent("qb-smallresources:server:RemoveItem", 'meatpie', 1)
            --QBCore.Functions.RemoveItem('meatpie')
    ...
    elseif args == 3 then 
        ...
        if food ~= nil then           
            Player.Functions.RemoveItem('steakpie')
            TriggerClientEvent('inventory:client:ItemBox', source, Core.Shared.Items['steakpie'], "remove")
            --TriggerServerEvent("qb-smallresources:server:RemoveItem", 'steakpie', 1)
            --QBCore.Functions.RemoveItem('steakpie')
    ...
    elseif args == 4 then 
        ...
        if food ~= nil then           
            Player.Functions.RemoveItem('chickenpie')
            TriggerClientEvent('inventory:client:ItemBox', source, Core.Shared.Items['chickenpie'], "remove")
            --TriggerServerEvent("qb-smallresources:server:RemoveItem", 'chickenpie', 1)
            --QBCore.Functions.RemoveItem('chickenpie')
    ...
    elseif args == 5 then 
        ...
        if food ~= nil then           
            Player.Functions.RemoveItem('mwburger')
            TriggerClientEvent('inventory:client:ItemBox', source, Core.Shared.Items['mwburger'], "remove")
            --TriggerServerEvent("qb-smallresources:server:RemoveItem", 'mwburger', 1)
            --QBCore.Functions.RemoveItem('mwburger')
    ...
    elseif args == 6 then 
        ...
        if food ~= nil then           
            Player.Functions.RemoveItem('mwcburger')
            TriggerClientEvent('inventory:client:ItemBox', source, Core.Shared.Items['mwcburger'], "remove")
            --TriggerServerEvent("qb-smallresources:server:RemoveItem", 'mwcburger', 1)
            --QBCore.Functions.RemoveItem('mwcburger')
    ...
    elseif args == 7 then 
        ...
        if food ~= nil then           
            Player.Functions.RemoveItem('mwbcburger')
            TriggerClientEvent('inventory:client:ItemBox', source, Core.Shared.Items['mwbcburger'], "remove")
            --TriggerServerEvent("qb-smallresources:server:RemoveItem", 'mwbcburger', 1)
            --QBCore.Functions.RemoveItem('mwbcburger')
