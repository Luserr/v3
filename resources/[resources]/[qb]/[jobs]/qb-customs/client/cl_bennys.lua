...
--#[Event Handlers]#--
RegisterNetEvent("qb-customs:purchaseSuccessful", function(job, amount)
    isPurchaseSuccessful = true
    attemptingPurchase = false
    QBCore.Functions.Notify("Purchase Successful")
    TriggerServerEvent("TransactionHandler")
    --exports['Renewed-Banking']:handleTransaction(job, title, -amount, "withdraw", job, receiver, type, transID)
end)
