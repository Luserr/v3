...
RegisterNetEvent('qb-pizzathis:bill', function()
    ...
    TriggerServerEvent('qb-pizzathis:bill:player', bill)
end)
...
CreateThread(function()
	...
	exports['qb-target']:AddBoxZone("PizzReceipt", vector3(811.32, -750.77, 26.78), 0.7, 0.35, { name="PizzReceipt", heading = 0.0, debugPoly=Config.Debug, minZ = 26.78, maxZ = 27.18, }, 
		{ options = { { event = "qb-pizzathis:bill", icon = "fas fa-credit-card", label = "Charge Customer", job = "pizzathis",
