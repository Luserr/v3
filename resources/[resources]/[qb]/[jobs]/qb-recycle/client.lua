...
CreateThread(function()
	if Config.RequireJob then
		...
		{ options = { { event = "qb-recycle:EnterTradeWarehouse", icon = "fas fa-recycle", label = "Enter Warehouse", job = Config.Job }, },
						distance = 1.5 })
	else
		Targets["RecyclingEnter"] =
		exports['qb-target']:AddBoxZone("RecyclingEnter", vector3(746.82, -1398.93, 26.55), 0.4, 1.6, { name="RecyclingEnter", debugPoly=Config.Debug, minZ=25.2, maxZ=28.0 },
		{ options = { { event = "qb-recycle:EnterTradeWarehouse", icon = "fas fa-recycle", label = "Enter Warehouse", }, },
						distance = 1.5 })
	end
    ...
    { options = { { event = "qb-recycle:ExitTradeWarehouse", icon = "fas fa-recycle", label = "Exit Warehouse", }, },
					distance = 1.5 })
	Targets["recycleduty"] =
    ...
    { options = { { event = "qb-recycle:dutytoggle", icon = "fas fa-hard-hat", label = "Toggle Recycling Duty", }, },
					distance = 1.5 })
	Targets["tradeitems"] =
    ...
    { options = { { event = "qb-recycle:Trade:Menu", icon = "fas fa-box", label = "Trade Materials", }, },
					distance = 1.5 })
	Targets["sellmats"] =
    ...
    { options = { { event = "qb-recycle:Selling:Menu", icon = "fas fa-box", label = "Sell Materials", }, },
					distance = 2.5 })
	...
	for i = 1, 6 do
		...
		{ options = { { event = "qb-recycle:Bottle:Menu", icon = "fas fa-certificate", label = "Sell Bottles", },	},
						distance = 2.5 })
	end
end)

local carryPackage = nil
RegisterNetEvent('qb-recycle:EnterTradeWarehouse', function()
...
RegisterNetEvent('qb-recycle:ExitTradeWarehouse', function()
	for k, v in pairs(props) do DeleteObject(props[k]) end props = {} 
	DoScreenFadeOut(500)
	while not IsScreenFadedOut() do
		Citizen.Wait(10)
	end
	if onDuty then TriggerEvent('qb-recycle:dutytoggle') end
...
--Third Eye Commands
RegisterNetEvent('qb-recycle:dutytoggle', function()
	if Config.RequireJob then
...
RegisterNetEvent("qb-recycle:CloseMenu", function() exports['qb-menu']:closeMenu() end)

--Sell Anim small Test
RegisterNetEvent('qb-recycle:SellAnim', function(data)
	local pid = PlayerPedId()
	loadAnimDict("mp_common")
	if data == 1 then
		TriggerServerEvent('qb-recycle:Selling:All')
	else
		TriggerServerEvent('qb-recycle:Selling:Mat', data)
	end
...
--Sell Anim small Test
RegisterNetEvent('qb-recycle:TradeAnim', function(data)
	local pid = PlayerPedId()
	loadAnimDict("mp_common")
...
--Material Buyer
RegisterNetEvent('qb-recycle:Selling:Menu', function()
    exports['qb-menu']:openMenu({
		{ header = "Material Selling", txt = "Sell batches of materials", isMenuHeader = true },
		{ header = "", txt = "❌ Close", params = { event = "qb-recycle:CloseMenu" } },
		{ header = "<img src=nui://"..Config.img..QBCore.Shared.Items["copper"].image.." width=30px>"..QBCore.Shared.Items["copper"].label, params = { event = "qb-recycle:SellAnim", args = 'copper' } },
		{ header = "<img src=nui://"..Config.img..QBCore.Shared.Items["plastic"].image.." width=30px>"..QBCore.Shared.Items["plastic"].label, params = { event = "qb-recycle:SellAnim", args = 'plastic' } },
		{ header = "<img src=nui://"..Config.img..QBCore.Shared.Items["aluminum"].image.." width=30px>"..QBCore.Shared.Items["aluminum"].label, params = { event = "qb-recycle:SellAnim", args = 'aluminum' } },
		{ header = "<img src=nui://"..Config.img..QBCore.Shared.Items["metalscrap"].image.." width=30px>"..QBCore.Shared.Items["metalscrap"].label, params = { event = "qb-recycle:SellAnim", args = 'metalscrap' }  },
		{ header = "<img src=nui://"..Config.img..QBCore.Shared.Items["steel"].image.." width=30px>"..QBCore.Shared.Items["steel"].label, params = { event = "qb-recycle:SellAnim", args = 'steel' } },
		{ header = "<img src=nui://"..Config.img..QBCore.Shared.Items["glass"].image.." width=30px>"..QBCore.Shared.Items["glass"].label, params = { event = "qb-recycle:SellAnim", args = 'glass' } },
		{ header = "<img src=nui://"..Config.img..QBCore.Shared.Items["iron"].image.." width=30px>"..QBCore.Shared.Items["iron"].label, params = { event = "qb-recycle:SellAnim", args = 'iron' } },
		{ header = "<img src=nui://"..Config.img..QBCore.Shared.Items["rubber"].image.." width=30px>"..QBCore.Shared.Items["rubber"].label, params = { event = "qb-recycle:SellAnim", args = 'rubber' } },
		{ header = "- ALL -", params = { event = "qb-recycle:SellAnim", args = 1 } }, 
    })
end)

--Recyclable Trader
RegisterNetEvent('qb-recycle:Trade:Menu', function()
    exports['qb-menu']:openMenu({
		{ header = "Material Trading", txt = "Trade collected materials", isMenuHeader = true },
 		{ header = "", txt = "❌ Close", params = { event = "qb-recycle:CloseMenu" } },
		{ header = "Trade 10 Materials", params = { event = "qb-recycle:TradeAnim", args = 1 } },
		{ header = "Trade 100 Materials", params = { event = "qb-recycle:TradeAnim", args = 2 } },
    })
end)

--Recyclable Trader
RegisterNetEvent('qb-recycle:Bottle:Menu', function()
    exports['qb-menu']:openMenu({
		{ header = "Material Selling", txt = "Sell batches of recyclables", isMenuHeader = true },
		{ header = "", txt = "❌ Close", params = { event = "qb-recycle:CloseMenu" } },
		{ header = "<img src=nui://"..Config.img..QBCore.Shared.Items["bottle"].image.." width=30px>".."Sell "..QBCore.Shared.Items["bottle"].label, params = { event = "qb-recycle:SellAnim", args = 'bottle' } },
		{ header = "<img src=nui://"..Config.img..QBCore.Shared.Items["can"].image.." width=30px>".."Sell "..QBCore.Shared.Items["can"].label, params = { event = "qb-recycle:SellAnim", args = 'can' } },
    })
end)
