...
RegisterNetEvent('qb-medusa:Client:signOn', function()
    if LocalPlayer.state['isLoggedIn'] and PlayerData.job.name == "medusa" then 
        TriggerServerEvent("QBCore:ToggleDuty")
    end
end)

RegisterNetEvent('qb-medusa:Client:stash', function()
    if onDuty and PlayerData.job.name == "medusa" then
...
RegisterNetEvent('qb-medusa:Client:accessBarMenu', function(data) -- Access bar menu, exploit checks
...
RegisterNetEvent('qb-medusa:Client:purchaseDrink', function(data) -- purchase drinks, exploit check
    name = data.type.name
    ...
    if name and price then 
        barConfirmation = {
            ...
            },
            {
                ...
                params = {
                    isServer = true,
                    event = "qb-medusa:Server:handleItem",
                    args = {
                        type = data.type.item,
...
RegisterNetEvent('qb-medusa:Client:barMenu', function() -- Open bar menu
    exports["qb-menu"]:openMenu(drinks)
end)

RegisterNetEvent('qb-medusa:Client:employeeManagement', function() -- Open boss menu
