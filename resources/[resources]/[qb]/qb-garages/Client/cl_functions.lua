    ...
    if  ParkingSpot ~= nil then
        if not IsViewing then
            ...
            QBCore.Functions.TriggerCallback('qb-garage:server:GetVehicleProperties', function(properties)
                ...
                exports['rhodinium-repo']:MechanicUpdate(veh, plate)
                            ...
                            QBCore.Functions.TriggerCallback('qb-garage:server:PayDepotPrice', function(paid)
                                if paid then
                                    ...
                                    if Data.plate ~= nil then
                                        ...
                                        TriggerServerEvent('qb-garages:server:UpdateOutsideVehicles', OutsideVehicles)
                                        TriggerServerEvent('qb-garages:server:modifystate', vehicleProps) --test this reeee
                                    end
                                    QBCore.Functions.TriggerCallback('qb-garage:server:GetVehicleProperties', function(properties)
                                        QBCore.Functions.TriggerCallback('qb-garages:server:GetVehicleWheelfit', function(wheelfit)
                                            if wheelfit ~= nil then
                                        ...
                                        exports['rhodinium-repo']:MechanicUpdate(veh, Data.plate)
