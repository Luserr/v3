...
RegisterNetEvent('qb-admin:client:toggleBlips', function()
    if not ShowBlips then
        ShowBlips = true
        NetCheck1 = true
        QBCore.Functions.Notify("Activated Players Blips", "success")
    else
        ShowBlips = false
        QBCore.Functions.Notify("Deactivated Players Blips", "error")
    end
end)
...
RegisterNetEvent('qb-admin:client:toggleNames', function()
    if not ShowNames then
        ShowNames = true
        NetCheck2 = true
        QBCore.Functions.Notify("Activated Players Names", "success")
    else
        ShowNames = false
        QBCore.Functions.Notify("Deactivated Players Names", "error")
    end
end)
