...
Config.RosterLink = {
    ['police'] = 'https://docs.google.com/spreadsheets/u/1/d/e/2PACX-1vSUL1Kw58xArYSs5dOY_8BULk0E3oKUaGBFB6c3T572pGQhc73vM9aQ9q9pP8pyzOcIgjKOxXEZQyJG/pubhtml',
    ...
    ['ambulance'] = 'https://docs.google.com/spreadsheets/d/1a4N5Dn8y-jHrOfjDGA4HrmyREdNNS0hS3jetLeRfV94/htmlview#gid=177078015',
    ['doj'] = '',
}
...
Config.PenalCode = {
    [1] = {
        ...
        [27] = {title = 'Possession of a Class 1 Firearm', class = 'Felony', id = 'P.C. 1027', months = 10, fine = 500, color = 'red'},
        [28] = {title = 'Possession of a Class 2 Firearm', class = 'Felony', id = 'P.C. 1028', months = 20, fine = 1000, color = 'red'},
        [29] = {title = 'Possession of a Class 3 Firearm', class = 'Felony', id = 'P.C. 1029', months = 40, fine = 6000, color = 'red'},
        [30] = {title = 'Possession of a Class 4 Firearm', class = 'Felony', id = 'P.C. 1030', months = 60, fine = 15000, color = 'red'},
        [31] = {title = 'Possession of a Class 5 Firearm', class = 'Felony', id = 'P.C. 1031', months = 100, fine = 25000, color = 'red'},
        [32] = {title = 'Possession of a Explosive', class = 'Felony', id = 'P.C. 1032', months = 150, fine = 40000, color = 'red'},
        [33] = {title = 'Possession of a Deadly Weapon', class = 'Misdemeanor', id = 'P.C. 1033', months = 5, fine = 500, color = 'orange'},
        [34] = {title = 'Unlawful Discharge of a Firearm', class = 'Misdemeanor', id = 'P.C. 1034', months = 12, fine = 1000, color = 'orange'},
        [35] = {title = 'Disrespecting of Romoy', class = 'Felony', id = 'P.C. 1035', months = 10000000, fine = 50000000, color = 'red'},
    },
    [2] = {
    ...
    [6] = {
        ...
        [21] = {title = 'Violation of Parole', class = 'Felony', id = 'P.C. 6021', months = 25, fine = 9000, color = red},
    },
    [7] = {
