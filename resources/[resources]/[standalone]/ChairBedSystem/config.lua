...
Config.objects = {
	...
	locations = {
		...
		[140] = {object="sm_pizzeria_office_chair01", verticalOffsetX=0.1, verticalOffsetY=0.0, verticalOffsetZ=-0.5, direction=168.0, bed=false},
		[141] = {object="sm_pizzeria_office_chair02", verticalOffsetX=0.1, verticalOffsetY=0.0, verticalOffsetZ=-0.5, direction=168.0, bed=false},
		[142] = {object="sm_pizzeria_chair_01", verticalOffsetX=0.1, verticalOffsetY=0.0, verticalOffsetZ=-0.5, direction=168.0, bed=false},
		[143] = {object="sm_pizzeria_wooden_chair", verticalOffsetX=0.1, verticalOffsetY=0.0, verticalOffsetZ=-0.5, direction=168.0, bed=false},
		[144] = {object="sm_pizzeria_armchair", verticalOffsetX=0.1, verticalOffsetY=0.0, verticalOffsetZ=-0.5, direction=168.0, bed=false},
		[145] = {object="sm_pizzeria_chesterfield_chair", verticalOffsetX=0.1, verticalOffsetY=0.0, verticalOffsetZ=-0.5, direction=168.0, bed=false},
		[146] = {object="sm_pizzeria_lounge_chair", verticalOffsetX=0.1, verticalOffsetY=0.0, verticalOffsetZ=-0.5, direction=168.0, bed=false},
	}
}
