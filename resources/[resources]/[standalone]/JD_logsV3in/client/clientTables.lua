...
ClientTables.WeaponNames = {
	...
	[tostring(GetHashKey('WEAPON_GLOCK'))] = 'PD Glock 22',
	...
	[tostring(GetHashKey('WEAPON_ASSAULTRIFLE'))] = 'Groza',
	[tostring(GetHashKey('WEAPON_ASSAULTRIFLE_MK2'))] = 'AK-47',
	...
	[tostring(GetHashKey('WEAPON_SPECIALCARBINE_MK2'))] = 'FN Scar 17',
	...
	[tostring(GetHashKey('WEAPON_M4'))] = "PD M4",
