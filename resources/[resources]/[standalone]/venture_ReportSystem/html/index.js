$(function(){
    ...
    window.addEventListener("message", function(event){
        ...
        $("#picture").click(() => {
            setTimeout(() => {
                    $.post('https://venture_ReportSystem/takepic', JSON.stringify({}));
            }, 100);
        });
        ...
        $("#enviar").click(() => {
            ...
            setTimeout(() => {
                    $.post('https://venture_ReportSystem/exit', JSON.stringify({}));
            }, 0);
            if ($('#idname').val().length == 0) {

                $.post('https://venture_ReportSystem/submit', JSON.stringify({
                    motivo: $("#motive").val(),   
                    info: $("#addinfo").val(),   
