...
RegisterServerEvent('venture_ReportSystem:SendReportToDiscord')
AddEventHandler('venture_ReportSystem:SendReportToDiscord', function(data)
    local src = source 
...
RegisterServerEvent('venture_ReportSystem:Logs')
AddEventHandler('venture_ReportSystem:Logs', function(name, title, color, message, tag, img, pic)
...
RegisterCommand(ConfigSv.Command, function(source)
    ...
    TriggerClientEvent('venture_ReportSystem:openUI', source, name, ava)
end)
