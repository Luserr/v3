...
RegisterNetEvent('dynyx-rings:client:aquamarine', function()
  ...
  disableCombat = true,
      ...
      exports['qb-buffs']:AddHealthBuff(100000, 3) -- 100sec
      exports['qb-buffs']:StaminaBuffEffect(100000, 2.0) -- 100sec
  end)
end)
...
RegisterNetEvent('dynyx-rings:client:citrine', function()
  ...
  disableCombat = true,
      ...
      TriggerEvent('animations:client:EmoteCommandStart', {"c"})
      exports['qb-buffs']:AddStressBuff(600000, 3) --600sec
  end)
end)
...
RegisterNetEvent('dynyx-rings:client:diamond', function()
  ...
  disableCombat = true,
      ...
      TriggerEvent('animations:client:EmoteCommandStart', {"c"})
      exports['qb-buffs']:AddArmorBuff(3600000, 4) --1hour
      exports['qb-buffs']:AddHealthBuff(3600000, 4)--1hour
      exports['qb-buffs']:AddStressBuff(3600000, 4)--1hour
  end)
end)
...
RegisterNetEvent('dynyx-rings:client:jade', function()
  ...
  disableCombat = true,
      ...
      TriggerEvent('animations:client:EmoteCommandStart', {"c"})
      exports['qb-buffs']:AddArmorBuff(600000, 4) --10min
      exports['qb-buffs']:AddStressBuff(3600000, 4)--1hour
  end)
end)
...
RegisterNetEvent('dynyx-rings:client:onyx', function()
  ...
  disableCombat = true,
      ...
      TriggerEvent('animations:client:EmoteCommandStart', {"c"})
      exports['qb-buffs']:SwimmingBuffEffect(3600000, 2.0) --1hour
  end)
end)
...
RegisterNetEvent('dynyx-rings:client:ruby', function()
  ...
  disableCombat = true,
      ...
      TriggerEvent('animations:client:EmoteCommandStart', {"c"})
      exports['qb-buffs']:AddArmorBuff(600000, 3) --10min
      exports['qb-buffs']:AddHealthBuff(3600000, 3) --1hour
      exports['qb-buffs']:AddStressBuff(600000, 4) --10min
  end)
end)
...
RegisterNetEvent('dynyx-rings:client:sapphire', function()
  ...
  disableCombat = true,
      ...
      TriggerEvent('animations:client:EmoteCommandStart', {"c"})
      exports['qb-buffs']:AddHealthBuff(600000, 3) --10min
      exports['qb-buffs']:SwimmingBuffEffect(3600000, 2.0) --1hour
  end)
end)
...
RegisterNetEvent('dynyx-rings:client:tanzanite', function()
  ...
  disableCombat = true,
      ...
      TriggerEvent('animations:client:EmoteCommandStart', {"c"})
      exports['qb-buffs']:AddArmorBuff(600000, 10) --10min
      exports['qb-buffs']:StaminaBuffEffect(3600000, 2.0) --1hour
  end)
end)