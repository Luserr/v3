...
Citizen.CreateThread(function()
  Wait(10000)
  TriggerServerEvent("qpixel-fx:setSteamId")
end)
RegisterNetEvent("qpixel-fix:setSteamIdClient")
AddEventHandler("qpixel-fix:setSteamIdClient", function(id)
  mySteamId = id
end)
...
--exports["qpixel-keybinds"]:registerKeyMapping(""","Misc", "Make it Rain", "+makeItRain", "-makeItRain")
