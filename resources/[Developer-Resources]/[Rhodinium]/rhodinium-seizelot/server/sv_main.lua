...
QBCore.Functions.CreateCallback('venture-seizelot:server:GetDepotVehiclesPD', function(source, cb)
    local state = 2
...
RegisterNetEvent('venture-seizelot:server:ReturnVehicle', function(data)
    local src = source
...
RegisterNetEvent('venture:server:CreateInvoice', function(billed, billerjob, billerfirstname, billiercitizenid , amount)
