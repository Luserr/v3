...
RegisterNetEvent("qpixel-editor:buildName")
AddEventHandler("qpixel-editor:buildName", function(name, objects)
    if objects then
...
RegisterNetEvent("qpixel-editor:destroyName")
AddEventHandler("qpixel-editor:destroyName", function(name)
    cleanUpArea(name)
...
function saveObjects(name)
    ...
    local changedTable = RPC.execute("objects:saveObjects2",dataToSend) 
    CURRENT_DELETED = {}
