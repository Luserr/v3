...
function StartTransmission()
    ...
    if not IsTalkingOnRadio then
        ...
        TriggerEvent("rhodinium:voice:transmissionStarted", { radio = true })
...
function LoadRadioModule()
    ...
    exports["rhodinium-callbacks"]:registerKeyMapping("", "Radio", "Push-To-Talk", "+transmitToRadio", "-transmitToRadio", "CAPITAL")
    RegisterCommand("+transmitToRadio", StartTransmission, false)
    RegisterCommand("-transmitToRadio", StopTransmission, false)

    exports["rhodinium-callbacks"]:registerKeyMapping("", "Radio", "Push-To-Talk (Secondary)", "+secondaryTransmitToRadio", "-secondaryTransmitToRadio")
    ...
    exports["rhodinium-callbacks"]:registerKeyMapping("", "Radio", "Volume Up", "+increaseRadioVolume", "-increaseRadioVolume")
    RegisterCommand("+increaseRadioVolume", IncreaseRadioVolume, false)
    RegisterCommand("-increaseRadioVolume", function() end, false)

    exports["rhodinium-callbacks"]:registerKeyMapping("", "Radio", "Volume Down", "+decreaseRadioVolume", "-decreaseRadioVolume")
    RegisterCommand("+decreaseRadioVolume", DecreaseRadioVolume, false)
    RegisterCommand("-decreaseRadioVolume", function() end, false)

    exports["rhodinium-callbacks"]:registerKeyMapping("", "Radio", "On / Off", "+toggleRadioState", "-toggleRadioState")
    ...
    exports["rhodinium-callbacks"]:registerKeyMapping("", "Radio", "Channel Up", "+increaseRadioChannel", "-increaseRadioChannel")
    RegisterCommand("+increaseRadioChannel", increaseRadioChannel, false)
    RegisterCommand("-increaseRadioChannel", function() end, false)

    exports["rhodinium-callbacks"]:registerKeyMapping("", "Radio", "Channel Down", "+decreaseRadioChannel", "-decreaseRadioChannel")
    RegisterCommand("+decreaseRadioChannel", decreaseRadioChannel, false)
    RegisterCommand("-decreaseRadioChannel", function() end, false)

    RegisterNetEvent("rhodinium:voice:radio:connect")
    AddEventHandler("rhodinium:voice:radio:connect", ConnectToRadio)

    RegisterNetEvent("rhodinium:voice:radio:disconnect")
    AddEventHandler("rhodinium:voice:radio:disconnect", DisconnectFromRadio)

    RegisterNetEvent("rhodinium:voice:radio:added")
    AddEventHandler("rhodinium:voice:radio:added", AddRadioSubscriber)

    RegisterNetEvent("rhodinium:voice:radio:removed")
    AddEventHandler("rhodinium:voice:radio:removed", RemoveRadioSubscriber)

    RegisterNetEvent("rhodinium:voice:radio:power")
    AddEventHandler("rhodinium:voice:radio:power", SetRadioPowerState)

    RegisterNetEvent("rhodinium:voice:radio:volume")
    AddEventHandler("rhodinium:voice:radio:volume", SetRadioVolume)
    ...
    TriggerEvent("rhodinium:voice:radio:ready")
