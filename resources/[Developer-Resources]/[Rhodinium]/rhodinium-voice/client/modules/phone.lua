...
function LoadPhoneModule()
    ...
    RegisterNetEvent("rhodinium:voice:phone:call:start")
    AddEventHandler("rhodinium:voice:phone:call:start", StartPhoneCall)

    RegisterNetEvent("rhodinium:voice:phone:call:end")
    AddEventHandler("rhodinium:voice:phone:call:end", StopPhoneCall)
    ...
    TriggerEvent("rhodinium:voice:phone:ready")

    Debug("[Phone] Module Loaded")
end

RegisterNetEvent("rhodinium-voice:setTransmissionDisabled", function ()
    WasEventCanceled()
