...
function ConnectToATCFrequency()
    local subscribers = RPC.execute("rhodinium-voice:atc:subscribe")
...
function DisconnectFromATCFrequency()
    ...
    RPC.execute("rhodinium-voice:atc:unsubscribe")
...
function LoadATCModule()
    ...
    exports["rhodinium-callbacks"]:registerKeyMapping("", "ATC", "Push-To-Talk", "+transmitToATCRadio", "-transmitToATCRadio")
    ...
    exports["rhodinium-callbacks"]:registerKeyMapping("", "ATC", "On / Off", "+toggleATCRadioState", "-toggleATCRadioState")
    ...
    exports["rhodinium-callbacks"]:registerKeyMapping("", "ATC", "Volume Up", "+increaseATCRadioVolume", "-increaseATCRadioVolume")
    ...
    exports["rhodinium-callbacks"]:registerKeyMapping("", "ATC", "Volume Down", "+decreaseATCRadioVolume", "-decreaseATCRadioVolume")
    ...
    RegisterNetEvent("rhodinium-voice:atc:connect", ConnectToATCFrequency)

    RegisterNetEvent("rhodinium-voice:atc:disconnect", DisconnectFromATCFrequency)

    RegisterNetEvent("rhodinium-voice:atc:setPowerState", SetATCRadioPowerState)

    RegisterNetEvent("rhodinium-voice:atc:addSubscriber", AddATCSubscriber)

    RegisterNetEvent("rhodinium-voice:atc:removeSubscriber", RemoveATCSubscriber)
